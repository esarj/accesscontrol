...
export declare const utils: {
     ...
     */
    iterateArray<T>(arrayInput: T[], callbackFn: (item: T, idx: number, input: T[]) => boolean | void, thisContext?: unknown | null): void;
    /**
     * Iterates through the keys of the given object. Breaking out early is
     * possible by returning `false`.
     */
    iterateObjectKeys(objectInput: UnknownObject, callbackFn: (key: string, idx: number, keys: string[]) => boolean | void, thisContext?: unknown | null): void;
