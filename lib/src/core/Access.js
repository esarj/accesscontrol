...
class Access {
    ...
    constructor(ac, roleOrInfo, denied = false) {
        ...
        if (typeof roleOrInfo === 'string' || Array.isArray(roleOrInfo)) {
        ...
        else if (utils_js_1.utils.type(roleOrInfo) === 'object') {
            if (roleOrInfo && Object.keys(roleOrInfo).length === 0) {
                throw new index_js_1.AccessControlError('Invalid IAccessInfo: {}');
            }
            ...
            if (roleOrInfo) {
                ...
                this._ = utils_js_1.utils.resetAttributes(roleOrInfo);
                if (utils_js_1.utils.isInfoFulfilled(this._))
                    utils_js_1.utils.commitToGrants(this._grants, this._, true);
            }
        }
        else if (roleOrInfo !== undefined) {
            // undefined is allowed (`roleOrInfo` can be omitted) but throw if
            // some other type is passed.
            throw new index_js_1.AccessControlError('Invalid role(s), expected a valid string, string[] or IAccessInfo.');
        }
    }
    // -------------------------------
    //  PUBLIC PROPERTIES
    ...
    role(value) {
        ...
        utils_js_1.utils.preCreateRoles(this._grants, value);
        this._.role = value;
        return this;
    }
    /**
    ...
    resource(value) {
        ...
        utils_js_1.utils.hasValidNames(value, true);
    ...
    extend(roles) {
        if (typeof this._.role === 'undefined') {
            throw new index_js_1.AccessControlError('Role(s) must be defined before calling extend().');
        }
        utils_js_1.utils.extendRole(this._grants, this._.role, roles);
        return this;
    }
    /**
     *  Alias of `extend`.
     ...
     */
    lock() {
        utils_js_1.utils.lockAC(this._ac);
        return this;
    }
    /**
    ...
    createOwn(resource, attributes) {
        return this._prepareAndCommit(index_js_2.Action.CREATE, index_js_2.Possession.OWN, resource, attributes);
    }
    /**
    ...
    createAny(resource, attributes) {
        return this._prepareAndCommit(index_js_2.Action.CREATE, index_js_2.Possession.ANY, resource, attributes);
    }
    /**
     *  Alias of `createAny`
     *  @private
    ...
    readOwn(resource, attributes) {
        return this._prepareAndCommit(index_js_2.Action.READ, index_js_2.Possession.OWN, resource, attributes);
    }
    /**
    ...
    readAny(resource, attributes) {
        return this._prepareAndCommit(index_js_2.Action.READ, index_js_2.Possession.ANY, resource, attributes);
    }
    /**
     *  Alias of `readAny`
     *  @private
    ...
    updateOwn(resource, attributes) {
        return this._prepareAndCommit(index_js_2.Action.UPDATE, index_js_2.Possession.OWN, resource, attributes);
    }
    /**
    ...
    updateAny(resource, attributes) {
        return this._prepareAndCommit(index_js_2.Action.UPDATE, index_js_2.Possession.ANY, resource, attributes);
    }
    /**
     *  Alias of `updateAny`
     *  @private
    ...
    deleteOwn(resource, attributes) {
        return this._prepareAndCommit(index_js_2.Action.DELETE, index_js_2.Possession.OWN, resource, attributes);
    }
    /**
    ...
    deleteAny(resource, attributes) {
        return this._prepareAndCommit(index_js_2.Action.DELETE, index_js_2.Possession.ANY, resource, attributes);
    }
    /**
     *  Alias of `deleteAny`
     *  @private
    ...
    _prepareAndCommit(action, possession, resource, attributes) {
        ...
        if (this._.denied) {
            ...
            this._.attributes = attributes ? utils_js_1.utils.toStringArray(attributes) : ['*'];
        }
        utils_js_1.utils.commitToGrants(this._grants, this._, false);
